...
def test_dish():
    dish1 = Dish("Macarrão com camarão", 32)
    ...
    dish1.add_ingredient_dependency(Ingredient("camarão"), 100)

    assert dish1.name == "Macarrão com camarão"
    assert dish1.price == 32
    ...
    assert dish1.get_ingredients == {Ingredient("camarão")}
